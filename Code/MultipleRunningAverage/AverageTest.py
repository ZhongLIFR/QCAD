...
SaveFilePath_QCAD = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_QCAD.csv'
SaveFilePath_LoPAD = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_LoPAD.csv'
SaveFilePath_ROCOD = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_ROCOD.csv'
SaveFilePath_IForest = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_IForest.csv'
SaveFilePath_LOF = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_LOF.csv'
SaveFilePath_KNN = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_KNN.csv'
SaveFilePath_SOD = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_SOD.csv'
SaveFilePath_HBOS = AbsRootDir + r'/QCAD/Data/TempFiles/abalone_HBOS.csv'
MB_dataset_path =  AbsRootDir + r'/QCAD/Data/GenData/MB/abaloneGene.csv'
